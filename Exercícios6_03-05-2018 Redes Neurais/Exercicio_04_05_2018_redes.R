...
#d) Treine uma rede Perceptron com eta = 0,3
...
#Transfomando os dois vetores de dados novos (teste) em matriz
...
#Maria teve como predição 1, o que indica que ela é uma potencial cliente para compra.
#Jõao teve como predição 0, o que indica que ele não é  uma potencial cliente  para compra.
...
#Definindo inputs e outputs e matriz de test em forma de ts
...
#Predição (dnet pk)
pred1.Maria <-mlp.output[[1]][[2]]
pred1.Maria
#Segundo o modelo, a promoção deve ser enviada a Maria, que provavelmente comprará.

pred1.Joao <- mlp.output[[2]][[2]]
pred1.Joao
# Segundo o modelo, a promoção não deve ser enviada a João, pois tem grandes chances de não aderir.
...
#Predição
pred2.Maria <-mlp.output[[1]][[2]]
pred2.Maria
#Segundo o modelo, Maria é uma potencial cliente de aderir a promoção.

pred2.Joao <- mlp.output[[2]][[2]]
pred2.Joao
#Segundo o modelo, João não é um potencial cliente de aderir a promoção, logo não deve enviar a promoção.
